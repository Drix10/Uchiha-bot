module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (!origin && !recipient) return message.channel.send('<a:phonework:870885494744035330> **This Channel Is Not In A Phone Call!**');
        const call = origin || recipient;
        if (!call.active) return message.channel.send('<a:phonework:870885494744035330> **This Call Is Not Currently Active!**');
        if (call.ownerOrigin && !bot.isOwner(message.author)) {
            return message.channel.send('<a:phonework:870885494744035330> **You Cannot Hang Up In An Admin Call!**');
        }
